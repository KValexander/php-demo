...
while($row = $result->fetch_assoc()) {
	$do = ($row["status"] == "Новая") ?
		sprintf('<p class="small"><a onclick="return window.confirm(\'Вы действительно хотите удалить заявку?\')" href="controllers/app_delete.php?app_id=%s">Удалить заявку</a></p>', $row["application_id"])
		: "";
